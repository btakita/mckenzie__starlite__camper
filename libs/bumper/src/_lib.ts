...
export const side__scale = drawing__width__in / (fender__depth__in + axis__across__in)
...
export const side__drawing__width__in = fender__depth__in + axis__across__in

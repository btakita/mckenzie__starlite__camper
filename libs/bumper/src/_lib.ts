...
export const camper__width__in = 96.75
export const camper__back__width__in = camper__width__in
export const camper__height__in = 11.5
export const camper__back__height__in = camper__height__in
export const back__width__in = camper__back__width__in
...
export const back__camper__x__in = 0
export const back__camper__height__in = camper__back__height__in
export const receivers__back__mid_distance__width__in = 66
export const receiver__under__body__y__in = 1
export const back__receivers__y__in = back__camper__height__in
...
export const back__receivers__offset__x__in = (camper__back__width__in - receivers__back__width__in) / 2
export const back__receiver__y1__in = receiver__under__body__y__in
...
export const fender__back__width__in = camper__back__width__in
export const back__receivers__axis__height = 24
export const fender__back__height__in = back__camper__height__in + receiver__under__body__y__in + fender__bumper__height__in
...
export const back__receivers__axis__x__in = (camper__back__width__in - back__receivers__axis__width__in) / 2
export const back__fender__axis__height__in = .24 / back__scale
export const back__fender__axis__x__in = 0
export const back__fender__axis__width__in = camper__back__width__in
...
export const camper__depth__in = 8
export const camper__back__depth__in = camper__depth__in
export const side__camper__height__in = 7.5
export const side__fender__height__in = side__camper__height__in + receiver__under__body__y__in + fender__bumper__height__in
export const side__frame__extension__in = 4
export const side__fender__width__in = camper__depth__in + side__frame__extension__in + receiver__width__in
export const side__frame__z__in = -2
export const side__frame__width__in = camper__depth__in + side__frame__z__in
...
export const side__receiver__under__body__y__in = receiver__under__body__y__in
...
export const side__frame__top__y__in = side__camper__height__in + receiver__under__body__y__in

...
export const back__width__in = body__back__width__in + 2 * fender__thickness__in
...
export const fender__back__height__in =
	back__body__height__in + frame__body__gap__in + fender__bumper__height__in
...
export const back__receivers__axis__y__in = fender__back__height__in + fender__thickness__in
...
export const fender__depth__in =
	body__depth__in + side__frame__extension__in + receiver__width__in + fender__thickness__in
export const side__fender__width__in = fender__depth__in
